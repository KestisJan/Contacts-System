...
<template>
<nav class="bg-[#1F3F77] h-[118.13px] w-full">
  <div class="h-full">
    <div class="flex items-center h-full justify-between px-4" >
            <div class="flex items-center flex-grow space-x-20">
              <div class="relative">
                <img :src="h6" alt="h6" class="absolute left-0 top-1/2 transform -translate-y-1/2 h-3 ml-15" style="width: 100%;"/>
                <img :src="logo" alt="Logo" class="h-16 ml-10" style="width: 100%;"/>
              </div>
            ...
            <div class="flex items-center">
              <img :src="UserLogo" alt="userLogo" class="h-12 px-6"/>
            </div>
    </div>
  </div>
</nav>
